...
//	ExportMapRepository repoExport;
	 ...
	 * @param initalVar	starting condition for administration (generated by the eTutor++)
	...
	public String newSetupAdminConfigSave(Model model,
		...
		if (configService.checkConfigExists(adminService.getIdTaskConfig()) != true) {
			configService.saveRow(UUID.randomUUID(), adminService.getIdDataset(), adminService.getMinSupportLevel(),
			...
			if (configService.getAprioriConfig(adminService.getIdTaskConfig()).get(0).getComment()
				...
				configService.saveRow(adminService.getIdTaskConfig(), adminService.getIdDataset(),
						adminService.getMinSupportLevel(), adminService.getNoRulesLevel(),
						adminService.getMinConfidenceLevel(), adminService.getAskRulesLevel(), nameTaskConfigI);
			} else {
				configService.saveRow(UUID.randomUUID(), adminService.getIdDataset(), adminService.getMinSupportLevel(),
						adminService.getNoRulesLevel(), adminService.getMinConfidenceLevel(),
						adminService.getAskRulesLevel(), nameTaskConfigI);
			}
		}
